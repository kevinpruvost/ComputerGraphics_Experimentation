...
InputSystem::Key GLFW_ContextAPI::__TranslateKey(int key)
{
    switch (key)
    {
...
InputSystem::KeyModifier GLFW_ContextAPI::__TranslateKeyModifier(int shiftState, int ctrlState, int altState)
{
...
InputSystem::KeyModifier GLFW_ContextAPI::__TranslateKeyModifier(int state)
{
     InputSystem::KeyModifier mods = InputSystem::KeyModifier::None;
...
InputSystem::MouseButton GLFW_ContextAPI::__TranslateMouseButton(int button)
{
    switch (button)
    {
